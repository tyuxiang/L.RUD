...
module mojo_top_0 (
  ...
  reg [1-1:0] M_button_module_button0;
  reg [1-1:0] M_button_module_button1;
  reg [1-1:0] M_button_module_button2;
  reg [1-1:0] M_button_module_button3;
  reg [1-1:0] M_button_module_button4;
  reg [1-1:0] M_button_module_button5;
  reg [1-1:0] M_button_module_button6;
  reg [1-1:0] M_button_module_button7;
  button_module_6 button_module (
    .button0(M_button_module_button0),
    .button1(M_button_module_button1),
    .button2(M_button_module_button2),
    .button3(M_button_module_button3),
    .button4(M_button_module_button4),
    .button5(M_button_module_button5),
    .button6(M_button_module_button6),
    .button7(M_button_module_button7),
  ...
  always @* begin
    ...
    M_button_module_button0 = p1_left;
    M_button_module_button1 = p1_right;
    M_button_module_button2 = p1_up;
    M_button_module_button3 = p1_down;
    M_button_module_button4 = p2_left;
    M_button_module_button5 = p2_right;
    M_button_module_button6 = p2_up;
    M_button_module_button7 = p2_down;
    led0 = M_led_module_led0;
    led1 = M_led_module_led1;
    led2 = M_led_module_led2;
    led3 = M_led_module_led3;
    ...
    case (M_state_q)
      ...
      IDLE_state: begin
        ...
        if (p1_left == 1'h1 | p1_right == 1'h1 | p1_up == 1'h1 | p1_down == 1'h1 | p2_left == 1'h1 | p2_right == 1'h1 | p2_up == 1'h1 | p2_down == 1'h1) begin
          M_state_d = CHECK_PLAYER_state;
        end
      end
      CHECK_PLAYER_state: begin
        io_led[16+0+0-:1] = 1'h1;
        if (M_button_module_player == M_answer_player_q) begin
          M_answer_player_d = 1'h1 - M_answer_player_q;
          M_state_d = CHECK_STEP_state;
        end else begin
          M_state_d = ERROR_state;
        end
      end
      CHECK_STEP_state: begin
        if (M_button_module_lrud == M_current_step_q) begin
          if (M_current_step_q == 2'h3) begin
            M_state_d = WIN_state;
          end else begin
            M_step_number_d = M_step_number_q + 1'h1;
            M_state_d = IDLE_state;
      ...
      WIN_state: begin
        M_reg_led_d = 16'haaaa;
      end
      ERROR_state: begin
        M_reg_led_d = 16'hffff;
      end
    endcase
  end
